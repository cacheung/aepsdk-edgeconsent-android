...
public class ConsentsTest {
    ...
    public void test_ConsentsCreation_With_ConsentDataMap() {
        ...
        Map<String, Object> consentData =
                CreateConsentXDMMap("y", "n", "vi", SAMPLE_METADATA_TIMESTAMP);
    ...
    public void test_ConsentsCreation_With_ImmutableMap() {
        ...
        // test
        Consents overridingConsent =
                new Consents(CreateConsentXDMMap("n", "n", SAMPLE_METADATA_TIMESTAMP));
    ...
    public void test_merge() {
        ...
        // test again
        Consents secondOverridingConsent =
                new Consents(CreateConsentXDMMap("n", "n", SAMPLE_METADATA_TIMESTAMP));
    ...
    public void test_merge_NullConsent() {
        // setup
        Consents baseConsent =
                new Consents(CreateConsentXDMMap("n", null, SAMPLE_METADATA_TIMESTAMP));
    ...
    public void test_setTimeStamp() {
        ...
        String iso8601DateString =
                TimeUtils.getISO8601UTCDateWithMilliseconds(new Date(currentTimestamp));
