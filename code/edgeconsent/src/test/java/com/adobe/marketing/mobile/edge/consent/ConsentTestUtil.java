...
class ConsentTestUtil {
    ...
    static String readTimestamp(Consents consents) {
        ...
        Map<String, Object> collectMap =
                (Map<String, Object>) allConsentMap.get(ConsentConstants.EventDataKey.METADATA);
    ...
    private static Map<String, Object> getAllConsentsMap(Consents consents) {
        ...
        Map<String, Object> allConsents =
                (Map<String, Object>) xdmMap.get(ConsentConstants.EventDataKey.CONSENTS);
