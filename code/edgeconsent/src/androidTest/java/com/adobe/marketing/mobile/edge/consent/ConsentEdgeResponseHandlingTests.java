...
public class ConsentEdgeResponseHandlingTests {
    ...
    public void setup() throws Exception {
        TestHelper.registerExtensions(
                Arrays.asList(MonitorExtension.EXTENSION, Consent.EXTENSION), null);
    }
    ...
    public void test_EdgeResponse_MergesWithCurrentConsent() throws Exception {
        ...
        MobileCore.dispatchEvent(
                buildEdgeConsentPreferenceEventWithConsents(
                        CreateConsentXDMMap("n"))); // edge response sets the collect consent to no
        waitForThreads(1000);
    ...
    public void test_EdgeResponse_NoConsentChangeAndNoTimestamp() throws Exception {
        ...
        // test
        MobileCore.dispatchEvent(
                buildEdgeConsentPreferenceEventWithConsents(CreateConsentXDMMap("y")));
        waitForThreads(1000);
    ...
    public void test_EdgeResponse_NoConsentChangeAndSameTimestamp() throws Exception {
        ...
        MobileCore.dispatchEvent(
                buildEdgeConsentPreferenceEventWithConsents(
                        CreateConsentXDMMap("y", "n", timestamp)));
        waitForThreads(1000);
