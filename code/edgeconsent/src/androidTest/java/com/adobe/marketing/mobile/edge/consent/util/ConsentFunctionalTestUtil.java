...
public class ConsentFunctionalTestUtil {
    ...
    public static String CreateConsentsXDMJSONString(
            final String collectConsentString, final String adIDConsentString, final String time) {
    ...
    public static String CreateConsentsXDMJSONString(
            ...
            final String time) {
        Map<String, Object> consentDataMap =
                CreateConsentXDMMap(
                        collectConsentString, adIDConsentString, personalizeConsentString, time);
            ...
            Consent.getConsents(
                    new AdobeCallbackWithError<Map<String, Object>>() {
                        ...
                        public void call(Map<String, Object> consents) {
                            getConsentResponse.put(
                                    ConsentTestConstants.GetConsentHelper.VALUE, consents);
                            latch.countDown();
                        }
                        ...
                        public void fail(AdobeError adobeError) {
                            getConsentResponse.put(
                                    ConsentTestConstants.GetConsentHelper.ERROR, adobeError);
                            latch.countDown();
                        }
                    });
            latch.await();
    ...
    public static Event buildEdgeConsentPreferenceEventWithConsents(
            final Map<String, Object> consents) {
    ...
    public static Event buildEdgeConsentPreferenceEvent(final String jsonString)
